...
from tkinter import Frame, Toplevel, Canvas, Button, StringVar, Label, Tk, W, LEFT
...
class App():
    ...
    def create_models(self):
        ...
        self.resources = list(CatanRenderConstants.resource_color_map.keys())
        self.create_players()
